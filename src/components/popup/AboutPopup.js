        ...
        <div className="left_inner">
            <div className="author">
              <div className="avatar_image">
                <img src='/public/img/logo/Logo_LT_2.png'
                 alt="" />
                <div className="main" data-img-url="/public/img/about/JB.jpg" />
              </div>
              <div className="short">
                <h3 className="name">
                  {aboutData.firstName}{" "}
              ...
              <ul>
                ...
                <li>
                  <div className="list_inner">
                    ...
                    <span>
                      <a href={`tel:${aboutData.phn}`}>{aboutData.phn}</a>
                    </span>
                  </div>
                </li>
                <li>
            ...
            <div className="edrea_tm_button full">
              <a href="docs/JT Resume.pdf" download>
                Download CV
              </a>
            </div>
          </div>
